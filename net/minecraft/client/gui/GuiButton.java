...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float mouseButton) {
        if (this.visible) {
            ...
            RoundedUtil.drawVerticalGradientOutlinedRoundedRect(this.xPosition, this.yPosition, this.width, this.height - 1, 7, 1,ClientHelper.getClientColor().darker(), ClientHelper.getClientColor());
            mc.mntsb_17.drawCenteredString(this.displayString, this.xPosition + this.width / 2F, this.yPosition + (this.height - 7.5f) / 2F, text.getRGB());
        }
    }
