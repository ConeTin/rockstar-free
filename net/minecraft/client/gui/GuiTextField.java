...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing())
            DrawHelper.drawRectWithGlow(this.xPosition - 1.5, this.yPosition - 1.5, this.xPosition + this.width + 1.5 - 60, this.yPosition + this.height-1.5, 5, 10, new Color(1,1,1,130));
        }
    ...
    public void drawTextBox1()
    {
        if (this.getVisible())
        {
            ...
            int j = this.cursorPosition - this.lineScrollOffset;
            int k = this.selectionEnd - this.lineScrollOffset;
            String s = (String) Minecraft.getMinecraft().fontRendererObj.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            boolean flag = j >= 0 && j <= s.length();
            boolean flag1 = this.isFocused && this.cursorCounter / 6 % 2 == 0 && flag;
            int l = this.enableBackgroundDrawing ? this.xPosition + 4 : this.xPosition;
            int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 : this.yPosition;
            ...
            this.xd = AnimationHelper.animation(this.xd, Minecraft.getMinecraft().currentScreen instanceof GuiChat ? (float)(sr.getScaledHeight() - 22) : (float)(sr.getScaledHeight() - 9), 0.1E-1F);
            ...
            {
                String s1 = flag ? s.substring(0, j) : s;
                j1 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s1, (float)l + 0.5f, (float)i1 - 0.5f, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length())
            {
                j1 = (int) Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Minecraft.getMinecraft().sfui16.getFontHeight(), -3092272);
                }
                else
                {
                    if(s.isEmpty()) {
                        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("", (float)k1 + 1, (float)i1 +  2, i);
                    } else {
                        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("_", (float)k1 + 1, (float)i1 + 2, i);
                    }
                }
            }
            ...
            if (k != j)
            {
                int l1 = l + (int) Minecraft.getMinecraft().sfui16.getStringWidth(s.substring(0, k));
