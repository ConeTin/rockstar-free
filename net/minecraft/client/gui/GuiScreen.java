...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected List<ImageButton> imageList = Lists.<ImageButton>newArrayList();
    ...
    protected ImageButton selectedButton2;
    ...
    protected final animbackground backgroundShader;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ...
            {
                ImageButton guibutton = this.imageList.get(i);

                if (guibutton.isHovered(mouseX, mouseY))
                {
