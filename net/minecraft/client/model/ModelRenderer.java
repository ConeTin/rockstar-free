...
public class ModelRenderer
{
    ...
    public ModelRenderer addCube(final float offX, final float offY, final float offZ, final float width, final float height, final float depth, final float delta, final boolean mirrored) {
    ...
    public ModelRenderer addCube(final float offX, final float offY, final float offZ, final float width, final float height, final float depth, final float delta) {
