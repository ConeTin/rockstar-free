...
public class RenderItem implements IResourceManagerReloadListener
{
            ...
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                if (Main.instance.featureDirector.getFeatureByClass(EnchantmentColor.class).isToggled()) {
                    if (EnchantmentColor.colorMode.currentMode.equals("Rainbow")) {
                        this.func_191965_a(p_191966_1_, DrawHelper.rainbow((int) f, 1, 1).getRGB());
    ...
    public void renderItemOverlays( ru.rockstar.api.utils.font.FontRenderer fr, ItemStack stack, int xPosition, int yPosition)
    {
     ...
     */
    public void renderItemOverlayIntoGUI( ru.rockstar.api.utils.font.FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text)
    {
        if (!stack.isEmpty())
        {
