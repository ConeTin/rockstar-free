    ...
    public void handleEntityStatus(SPacketEntityStatus packetIn) {
        ...
        if (entity != null) {
            if (packetIn.getOpCode() == 21) {
                ...
                this.clientWorldController.playSound(entity.posX, entity.posY, entity.posZ, SoundEvents.field_191263_gW,
                        entity.getSoundCategory(), 1.0F, 1.0F, false);

                if (entity == this.gameController.player) {
                    if(NoRender.antiTotem.getBoolValue() && Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled()) {
