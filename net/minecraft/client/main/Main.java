...
public class Main
{
	...
	public static String username = "RockUser";
	public static String uid = "0";
	
	public static void main(String[] p_main_0_)
    {
		 /*
    	File file = new File("C:\\Rockstar\\JVM\\bin\\p.ini");
    	...
    	*/
    	...
    	if (SystemTray.isSupported()) {
            ...
            trayIcon.displayMessage("Rockstar Free - чит запущен", "Приятной игры, группа вк - @rockstarclient",
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Rockdev38");
