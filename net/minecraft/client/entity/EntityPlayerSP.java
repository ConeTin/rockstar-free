...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        event2.call();
        EventPreMotionUpdate eventPre = new EventPreMotionUpdate(this.rotationYaw, this.rotationPitch, this.posY, getLocation());
        eventPre.call();
    ...
    public LPositionHelper getLocation() {
        if (location == null)
            location = new LPositionHelper(mc.player.posX, mc.player.posY, mc.player.posZ, mc.player.onGround);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= Main.instance.featureDirector.getFeatureByClass(NoSlowDown.class).isToggled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= Main.instance.featureDirector.getFeatureByClass(NoSlowDown.class).isToggled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
