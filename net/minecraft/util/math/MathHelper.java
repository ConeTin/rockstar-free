...
public class MathHelper {
    ...
    public static float lerp_degrees(float a, float b, float t) {
        ...
        return a + MathHelper.wrapDegrees(b - a) * clamp(t, 0, 1);
    }
    ...
    public static float SmoothDamp(float current, float target, float currentVelocity, float smoothTime, float maxSpeed) {
        ...
        float num2 = (float) (num * Feature.deltaTime());
        ...
        float num6 = (float) ((currentVelocity + num * value) * Feature.deltaTime());
        currentVelocity = (currentVelocity - num * num6) * num3;
        float num7 = target + (value + num6) * num3;
        if (num4 - current > 0f == num7 > num4) {
            num7 = num4;
            currentVelocity = (float) ((num7 - num4) / Feature.deltaTime());
        }
