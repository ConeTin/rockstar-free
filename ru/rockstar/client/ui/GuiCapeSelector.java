...
public class GuiCapeSelector extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.imageButtons.add(new ImageButton(new ResourceLocation("rockstar/close-button.png"), width + 106, height - 135, 8, 8, "", 19));
        this.imageButtons.add(new ImageButton(new ResourceLocation("rockstar/arrow/arrow-right.png"), width + 30, height + 52, 32, 25, "", 56));
        this.imageButtons.add(new ImageButton(new ResourceLocation("rockstar/arrow/arrow-left.png"), width - 50, height + 52, 32, 25, "", 55));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        DrawHelper.drawSkeetRectWithoutBorder(width - 70, height - 80, width + 80, height + 20);
        DrawHelper.drawSkeetButton(width - 70, height - 78, width + 80, height + 80);
        mc.neverlose500_16.drawStringWithOutline("Cape Changer", width - 100, height - 133, -1);
