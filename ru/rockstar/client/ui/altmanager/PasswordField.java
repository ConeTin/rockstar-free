...
public class PasswordField extends Gui {
   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         if (this.getEnableBackgroundDrawing()) {
            DrawHelper.drawRect((double)this.xPos, (double)this.yPos, (double)(this.xPos + this.width), (double)(this.yPos + this.height), (new Color(30, 30, 30, 185)).getRGB());
            DrawHelper.drawGradientRect((double)this.xPos, (double)this.yPos, (double)(this.xPos + this.width), (double)(this.yPos + this.height), (new Color(1, 1, 1, 255)).getRGB(), (new Color(5, 5, 5, 255)).getRGB());
         }
      ...
      //      var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), (double)((float)var7), (double)((float)var8), var1);
         }
        ...
        //    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(var4.substring(var2), (double)((float)var9), (double)((float)var8), var1);
         }
     ...
     //          Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("_", (double)((float)var11), (double)((float)var8), var1);
            }
         }
   ...
   private void drawCursorVertical(int par1, int par2, int par3, int par4) {
      ...
      var7.pos((double)par1, (double)par4, 0.0D).endVertex();
      var7.pos((double)par3, (double)par4, 0.0D).endVertex();
      var7.pos((double)par3, (double)par2, 0.0D).endVertex();
      var7.pos((double)par1, (double)par2, 0.0D).endVertex();
      var6.draw();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
