        ...
        if (autoFarm.getBoolValue()) {
            ...
            for (BlockPos pos : blockPositions) {
                ...
                if (isCheck(Block.getIdFromBlock(state.getBlock()))) {
                    ...
                    if (block instanceof BlockCrops || block instanceof BlockCarrot || block instanceof BlockMelon || block instanceof BlockPumpkin || block instanceof BlockPotato || block instanceof BlockBeetroot || block instanceof BlockPotato) {
