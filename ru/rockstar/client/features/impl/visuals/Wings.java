...
public class Wings extends Feature {
    ...
    public void onRender3D(Event3D event) {
        ...
        if (mc.gameSettings.thirdPersonView == 1 || mc.gameSettings.thirdPersonView == 2) {
           ...
           GL11.glRotatef((mc.player.isSneaking() ? 12 : 0), 1.0f, 0.0f, 0);
           GL11.glTranslatef(0.0F, (float)((double)mc.player.height + height - 1), -0.3F);
           ...
           for(i = 0.0F; (double)i < 360.5D; ++i) {
              ...
              GL11.glVertex3d(Math.cos((double)i * 2) * 1.2D, 0.6D, Math.sin((double)i * 2) * 0.01D);
              GL11.glVertex3d(Math.cos((double)i * 2) * 2D, 0.5D, Math.sin((double)i * 2) * 0.01D);
              GL11.glVertex3d(Math.cos((double)i * 2) * 1.9D, 0.3D, Math.sin((double)i * 2) * 0.01D);
              GL11.glVertex3d(Math.cos((double)i * 2) * 1.8D, 0.2D, Math.sin((double)i * 2) * 0.01D);
              GL11.glVertex3d(Math.cos((double)i * 2) * 1.6D, 0.1D, Math.sin((double)i * 2) * 0.01D);
              GL11.glVertex3d(Math.cos((double)i * 2) * 0.5D, 0.0D, Math.sin((double)i * 2) * 0.01D);
