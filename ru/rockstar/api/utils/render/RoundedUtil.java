...
public class RoundedUtil {
    ...
    public static void drawHorizontalGradientOutlinedRoundedRect(float x, float y, float width, float height, float radius, float expand, Color color, Color color2) {
    	drawGradientHorizontal(x,y,width,height,radius,color.brighter(),color2.brighter());
    ...
    public static void drawVerticalGradientOutlinedRoundedRectWithGlow(float x, float y, float width, float height, float radius, float expand, int glowIntencivity, Color color, Color color2) {
    	RenderUtils.drawBlurredShadow(x + 1,y,width,height, glowIntencivity,color2.brighter());
    	
    	drawGradientVertical(x,y,width,height,radius,color.brighter(),color2.brighter());
    	
    	float e = expand;
    	
    	drawGradientVertical(x + e,y + e,width - e - e,height - e - e,radius - 1, color,color2);
    }
    
    public static void drawVerticalGradientOutlinedRoundedRect(float x, float y, float width, float height, float radius, float expand, Color color, Color color2) {
    	drawGradientVertical(x,y,width,height,radius,color.brighter(),color2.brighter());
