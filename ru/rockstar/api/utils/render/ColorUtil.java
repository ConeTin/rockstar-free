...
public class ColorUtil {
    ...
    public static int interpolateHue(float color1, float color2, float amount) {
        amount = Math.min(1, Math.max(0, amount));
        Color cColor1 = new Color((int) color1);
        Color cColor2 = new Color((int) color2);
        return interpolateColorC(cColor1, cColor2, amount).getRGB();
    }

    public static Color interpolateColorC(Color color1, Color color2, float amount) {
        amount = Math.min(1, Math.max(0, amount));
        return new Color(interpolateColor(color1.getRed(), color2.getRed(), amount),
                interpolateColor(color1.getGreen(), color2.getGreen(), amount),
                interpolateColor(color1.getBlue(), color2.getBlue(), amount),
                interpolateColor(color1.getAlpha(), color2.getAlpha(), amount));
    }
    ...
    public static Color interpolateColorHue(Color color1, Color color2, float amount) {
        ...
        Color resultColor = Color.getHSBColor(interpolateHue(color1HSB[0], color2HSB[0], amount),
                interpolateHue(color1HSB[1], color2HSB[1], amount), interpolateHue(color1HSB[2], color2HSB[2], amount));
