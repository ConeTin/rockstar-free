...
public class Util {
    ...
    public static void drawHead1(ResourceLocation skin, int width, int height) {
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        mc.getTextureManager().bindTexture(skin);
        Gui.drawScaledCustomSizeModalRect(width, height, 8.0f, 8.0f, 8, 8, 23, (int) 22.5, 64.0f, 64.0f);
    }

    public static void drawHead2(ResourceLocation skin, int width, int height) {
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        mc.getTextureManager().bindTexture(skin);
        Gui.drawScaledCustomSizeModalRect(width, height, 8.0f, 8.0f, 8, 8, 30, (int) 30, 64.0f, 64.0f);
    }
    ...
    public static int findHotbarPotion() {
        for (int o = 0; o < 9; o++) {
            ...
            if (item != null && Util.isPotion(item))
                return o;
        }
        return -1;
    }
